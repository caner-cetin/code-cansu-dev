...
var Languages = map[int32]Language{
	...
	51: {
		...
		RunCmd:     "/usr/local/mono-6.6.0.161/bin/mono Main.exe %s",
	},
	52: {
		Id:         52,
		Name:       "C++ (GCC 10.2)",
		...
		RunCmd:     "LD_LIBRARY_PATH=/usr/local/gcc-10.2/lib64 ./a.out %s",
	},
	53: {
		Id:         53,
		Name:       "C++ (GCC 11.5)",
		...
		RunCmd:     "LD_LIBRARY_PATH=/usr/local/gcc-11.5/lib64 ./a.out %s",
	},
	54: {
		Id:         54,
		Name:       "C++ (GCC 12.4)",
		...
		RunCmd:     "LD_LIBRARY_PATH=/usr/local/gcc-12.4/lib64 ./a.out %s",
	},
	55: {
		Id:         55,
		Name:       "Common Lisp (SBCL 2.4.9)",
		SourceFile: "script.lisp",
		RunCmd:     "ASDF_SBCL_VERSION=2.4.9 asdf exec sbcl --script script.lisp %s",
	},
	56: {
		Id:         56,
		Name:       "D (DMD 2.109.1)",
	...
	57: {
		...
		RunCmd:     "ASDF_ELIXIR_VERSION=1.17.3 asdf exec elixir script.exs %s",
	},
	58: {
		Id:         58,
		Name:       "Erlang (OTP 27.1.2)",
		SourceFile: "main.erl",
		RunCmd:     "/bin/sed -i '1s/^/\\n/' main.erl && ASDF_ERLANG_VERSION=27.1.2 asdf exec escript main.erl %s",
	},
	59: {
		Id:         59,
		...
		RunCmd:     "LD_LIBRARY_PATH=/usr/local/gcc-13.3/lib64 ./a.out %s",
	},
	60: {
		Id:         60,
		Name:       "Go (1.23.2)",
	...
	62: {
		...
		RunCmd:     "/usr/local/openjdk23/bin/java Main %s",
	},
	63: {
		Id:         63,
		Name:       "JavaScript (Bun 1.1.33)",
		SourceFile: "script.js",
		RunCmd:     "ASDF_BUN_VERSION=1.1.33 asdf exec bun script.js %s",
	},
	64: {
		Id:         64,
		Name:       "Lua (5.4.7)",
		...
		RunCmd:     "ASDF_LUA_VERSION=5.4.7 asdf exec lua ./luac.out %s",
	},
	65: {
		Id:         65,
		Name:       "OCaml (5.2.0)",
	...
	66: {
		...
		Name:       "Octave (9.2.0)",
		SourceFile: "script.m",
		RunCmd:     "/usr/local/octave-9.2.0/bin/octave-cli -q --no-gui --no-history script.m %s",
	},
	67: {
		Id:         67,
	...
	68: {
		...
		RunCmd:     "/usr/local/php-8.3.13/bin/php script.php %s",
	},
	69: {
		Id:         69,
	...
	70: {
		...
		RunCmd:     "ASDF_PYTHON2_VERSION=2.7.17 ASDF_PYTHON_VERSION=2.7.17 asdf exec python2 script.py %s",
	},
	71: {
		Id:         71,
		Name:       "Python (3.12.7)",
		SourceFile: "script.py",
		RunCmd:     "ASDF_PYTHON3_VERSION=3.12.7 ASDF_PYTHON_VERSION=3.12.7 asdf exec python3 script.py %s",
	},
	72: {
		Id:         72,
		Name:       "Ruby (2.7.0)",
		SourceFile: "script.rb",
		RunCmd:     "ruby script.rb %s",
	},
	73: {
		Id:         73,
		Name:       "Rust (1.82.0)",
	...
	74: {
		...
		RunCmd:     "ASDF_BUN_VERSION=1.1.33 asdf exec bun script.ts %s",
	},
	75: {
		Id:         75,
		Name:       "C (Clang 19.1.0)",
	...
	77: {
		...
		RunCmd:     "LD_LIBRARY_PATH=/usr/local/gnucobol-3.1.2/lib ./main %s",
	},
	78: {
		Id:         78,
		Name:       "Kotlin (2.0.21)",
		...
		RunCmd:     "ASDF_KOTLIN_VERSION=2.0.21 asdf exec kotlin MainKt %s",
	},
	79: {
		Id:         79,
	...
	80: {
		...
		Name:       "R (4.4.1)",
		SourceFile: "script.r",
		RunCmd:     "/usr/local/r-4.4.1/bin/Rscript script.r %s",
	},
	81: {
		Id:         81,
		Name:       "Scala (3.5.2)",
		...
		RunCmd:     "/usr/local/scala-3.5.2/bin/scala run -cp . -M Main %s",
	},
	82: {
		Id:         82,
		Name:       "SQL (SQLite 3.27.2)",
		SourceFile: "script.sql",
		RunCmd:     "/bin/cat script.sql | /usr/bin/sqlite3 %s db.sqlite",
	},
	83: {
		Id:         83,
		Name:       "Swift (6.0.1)",
	...
	84: {
		...
		RunCmd:     "/usr/bin/mono Main.exe %s",
	},
	85: {
		Id:         85,
		Name:       "Perl (5.40.0)",
		SourceFile: "script.pl",
		RunCmd:     "ASDF_PERL_VERSION=2.0.21 asdf exec perl %s script.pl",
	},
	86: {
		Id:         86,
		Name:       "Clojure (1.11.2)",
		SourceFile: "main.clj",
		RunCmd:     "/usr/local/bin/clojure clojure %s main.clj",
	},
	87: {
		Id:         87,
		Name:       "Nim (2.2.0)",
	...
	88: {
		...
		RunCmd:     "/usr/local/bin/java -cp \".:/usr/local/groovy-4.0.23/lib/*\" script %s",
	},
	90: {
		Id:         90,
		Name:       "C (GCC 13.3)",
...
// => tmp/timing_stats.log 	(space seperated string info, wall user sys in order) 0.00000 0.00000 0.00000
